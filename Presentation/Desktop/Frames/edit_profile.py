...
class EditProfileFrame(Frame):
    def __init__(self, window, view_manager, employee_business):
        ...
        self.combo_status.grid(row=4, column=1, padx=10, pady=(0,5), sticky="ew")
        ...
        self.combo_role.grid(row=5, column=1, padx=10, pady=(0,5), sticky="ew")
    ...
    def submit_button_clicked(self):
        ...
        response = self.employee_business.update_employee(self.current_employee.id, firstname, lastname, username, email, status_id, role_id)
        if response.success:
