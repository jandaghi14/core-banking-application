...
class RegisterFrame(Frame):
    def __init__(self, window, employee_business:EmployeeBusiness,view_manager):
        ...
        self.label_phone.grid(row=5,column=0,padx=10,pady=(0,10),sticky='e')
        self.entry_phone= Entry(self)
        self.entry_phone.grid(row=5, column=1, pady=(0,10),padx=(0,10),sticky='we')
        
        
        
        self.label_password = Label(self, text='Password:')
        self.label_password.grid(row=6,column=0,padx=10,pady=(0,10),sticky='e')
        self.entry_password= PasswordEntry(self)
        self.entry_password.grid(row=6, column=1, pady=(0,10),padx=(0,10),sticky='we')

        self.captcha= CaptchaComponent(self)
        self.captcha.grid(row=7,column=0,columnspan=2,pady=10)



        self.register_button = Button(self, text="Register!", command=self.register_button_clicked)
        self.register_button.grid(row=8, column=0,padx=10, pady=(0, 10), sticky="w")

        self.goto_login_button = Button(self, text="Go to Login!", command=self.clicked_go_to_login)
        self.goto_login_button.grid(row=9, column=0,padx=10, pady=(0, 10), sticky="w")
    ...
    def register_button_clicked(self):
        ...
        response= self.employee_business.register(firstname, lastname, username,password,email,phone)
